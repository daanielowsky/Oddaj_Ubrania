...
<header class="header--form-page">
    ...
    <div style="font-size: large; padding-left: 30%">
        <h2>Twoje zbiórki:</h2>
        <c:forEach items="${collections}" var="lista">
            <p>- Zbiórka dla: <c:out value="${lista.organizations.name}"/></p>
            <p>- Ilość oddanych worków: <c:out value="${lista.numberOfPlasticBags}"/></p>
            <p>- Stworzono: <c:out value="${lista.created}}"/></p>
        </c:forEach>
    </div>
</header>
</body>
