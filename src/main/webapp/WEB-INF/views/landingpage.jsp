        ...
        <form>
            ...
            <div data-step="1" class="active">
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        <input
                                type="checkbox"
                                name="${collection.thingsToGiveaway}"
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        <input type="checkbox" name="${collection.thingsToGiveaway}" value="toys"/>
                        <span class="checkbox"></span>
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        <input type="checkbox" name="${collection.thingsToGiveaway}" value="books"/>
                        <span class="checkbox"></span>
                ...
                <div class="form-group form-group--checkbox">
                    <label>
                        <input type="checkbox" name="${collection.thingsToGiveaway}" value="other"/>
                        <span class="checkbox"></span>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <input type="number" name="${collection.numberOfPlasticBags}" step="1" min="1"/>
                    </label>
                </div>
            ...
            <div data-step="3">
                ...
                <div class="form-group form-group--dropdown">
                    <select name="${collection.localization}">
            ...
            <div data-step="4">
                ...
                <div class="form-group form-group--checkbox">
                    <c:forEach items="${organizations}" var="organization">
                        ...
                        <br>
                        <c:out value="${organization.mission}"/>
                        <br>
                    </c:forEach>
                </div>
